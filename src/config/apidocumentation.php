...
return [
   ...
   'output_folder' => 'public/docs',
    ...
    'strategies' => [
        'metadata' => [
            \SeacoastBank\AutoDocumentation\Lib\Strategies\Metadata\GetFromDocBlocks::class,
        ],
        'urlParameters' => [
            \SeacoastBank\AutoDocumentation\Lib\Strategies\UrlParameters\GetFromUrlParamTag::class,
        ],
        'queryParameters' => [
            \SeacoastBank\AutoDocumentation\Lib\Strategies\QueryParameters\GetFromQueryParamTag::class,
        ],
        'headers' => [
            \SeacoastBank\AutoDocumentation\Lib\Strategies\RequestHeaders\GetFromRouteRules::class,
        ],
        'bodyParameters' => [
            \SeacoastBank\AutoDocumentation\Lib\Strategies\BodyParameters\GetFromBodyParamTag::class,
        ],
        'responses' => [
            \SeacoastBank\AutoDocumentation\Lib\Strategies\Responses\UseTransformerTags::class,
            \SeacoastBank\AutoDocumentation\Lib\Strategies\Responses\UseResponseTag::class,
            \SeacoastBank\AutoDocumentation\Lib\Strategies\Responses\UseResponseFileTag::class,
            \SeacoastBank\AutoDocumentation\Lib\Strategies\Responses\UseApiResourceTags::class,
            \SeacoastBank\AutoDocumentation\Lib\Strategies\Responses\ResponseCalls::class,
        ],
    ],
     ...
     *
     */
    'routeMatcher' => \SeacoastBank\AutoDocumentation\Matching\RouteMatcher::class,
];
